...
CREATE TABLE IF NOT EXISTS poker_tables (
    ...
    name TEXT NOT NULL DEFAULT 'Table sans nom',
...
CREATE INDEX IF NOT EXISTS idx_poker_tables_name ON poker_tables(name);

-- Création des triggers pour mettre à jour updated_at
DROP TRIGGER IF EXISTS update_poker_tables_updated_at ON poker_tables;
DROP TRIGGER IF EXISTS update_table_players_updated_at ON table_players;
...
BEGIN
    ...
    UPDATE poker_tables
    SET name = 'Table ' || id::text
    WHERE name = 'Table sans nom';
